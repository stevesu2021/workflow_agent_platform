...
- **提示词模板**：
  ...
  ```
    ...
    return {
        ...
        "results": {
            **state.get("results", {}),
            "step_1": response.content
        }
    }


def step_2(state: AgentState) -> dict:
    """
    Node: step_2
...
- **提示词模板**：
  ...
  ```
    ...
    return {
        ...
        "results": {
            **state.get("results", {}),
            "step_2": response.content
        }
    }


def step_3(state: AgentState) -> dict:
    """
    Node: step_3
...
- **提示词模板**：
  ...
  ```
    ...
    return {
        ...
        "results": {
            **state.get("results", {}),
            "step_3": response.content
        }
    }


def step_4(state: AgentState) -> dict:
    """
    Node: step_4
...
- **提示词模板**：
  ...
  ```
    ...
    return {
        ...
        "results": {
            **state.get("results", {}),
            "step_4": response.content
        }
    }


def step_5(state: AgentState) -> dict:
    """
    Node: step_5
...
- **提示词模板**：
  ...
  ```
    ...
    return {
        ...
        "results": {
            **state.get("results", {}),
            "step_5": response.content
        }
    }


def step_6(state: AgentState) -> dict:
    """
    Node: step_6
...
- **提示词模板**：
  ...
  ```
    ...
    return {
        ...
        "results": {
            **state.get("results", {}),
            "step_6": response.content
        }
    }


def step_7(state: AgentState) -> dict:
    """
    Node: step_7
